...
export default function GitHubProjectPanel({ projectId }) {
            ...
            <section className="mt-8">
              ...
              {loadingGithubData ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                  <GitHubList title="Issues" items={issues} emptyMessage="No issues found." />
                  <GitHubList title="Pull requests" items={pulls} emptyMessage="No pull requests found." />
                </div>
              ) : (
...
function GitHubList({ title, items, emptyMessage }) {
  return (
        ...
        <div className="mt-4 space-y-3">
          {items.map((item) => (
            <a
              ...
              href={item.html_url}
              target="_blank"
              className="block rounded-xl border border-slate-800 bg-slate-900 p-4 hover:border-blue-500 transition"
            >
              <div className="flex items-start justify-between gap-4">
                <div>
